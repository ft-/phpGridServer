...
{
	trigger_error("/friends Method=".$_RPC_REQUEST->Method);
}

require_once("lib/services.php");

$FriendsService = getService("RPC_Friends");
...
else if(!file_exists("friends/rpc_".$_RPC_REQUEST->Method.".php"))
{
	http_response_code("400");
	exit;
}
...
{
	require_once("friends/rpc_".$_RPC_REQUEST->Method.".php");
}
