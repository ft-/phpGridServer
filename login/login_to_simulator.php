...
if($option_user_capabilities)
{
    ...
    $folderStruct->uri = $homeGrid->HomeURI."homecap/FetchInventory2.php/$sessionID";
    $userCapArray[] = $folderStruct;
    $folderStruct = new RPCStruct();
    $folderStruct->capability = "FetchInventoryDescendents2";
    $folderStruct->uri = $homeGrid->HomeURI."homecap/FetchInventoryDescendents2.php/$sessionID";
    $userCapArray[] = $folderStruct;
    $folderStruct = new RPCStruct();
    $folderStruct->capability = "CreateInventoryCategory";
    $folderStruct->uri = $homeGrid->HomeURI."homecap/CreateInventoryCategory.php/$sessionID";
    $userCapArray[] = $folderStruct;
