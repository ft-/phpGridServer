...
{
	trigger_error("/hg-groups Method=".$_RPC_REQUEST->Method);
}

require_once("lib/services.php");

$groupsService = getService("RPC_HGGroups");
...
else if(!file_exists("hggroups/rpc_".$_RPC_REQUEST->Method.".php"))
{
	http_response_code("400");
	exit;
}
...
{
	require_once("hggroups/rpc_".$_RPC_REQUEST->Method.".php");
}
